...
The architecture rework is complete. See [TODO.md](TODO.md) for the prioritized product roadmap, [docs/architecture.md](docs/architecture.md) for the stable dependency and persistence boundaries, [docs/server-design.md](docs/server-design.md) for the intended travel, economy, government, and regional-scarcity direction, [docs/pow-design-notes.md](docs/pow-design-notes.md) for explicitly unresolved POW brainstorming, and [docs/worktree-roadmap.md](docs/worktree-roadmap.md) for the dependency-aware multi-worktree queue for net-new MVP work.
