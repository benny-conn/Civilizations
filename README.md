...
A3 adds schema 8 repair jobs/items, deterministic absolute completion targets, fresh-world manual-repair accounting, configurable victor proceeds, and durable cursors. Its schema-7-to-8 upgrade and a second clean restart passed on the real Paper fixture. A3 deliberately performs no Paper world mutation; the B3 runner and repair command surface are the next integration slice.
