...
restart. See [cane policy](cane-policy.md). S2b paired portal sites is next; animal mechanics
still require the S0 experiment. No parallel merge queue is active for these follow-ups.
