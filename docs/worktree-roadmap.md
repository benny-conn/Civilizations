...
A2, B2, C1, and C2 are now ready. Keep A2 → A3 sequential in the durable-core lane, serialize B2 after B1 in the Paper-integration lane, and allow the operations items to proceed independently. B3 remains blocked until A3 supplies persisted repair jobs and cursors.
