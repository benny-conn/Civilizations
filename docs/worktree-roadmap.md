...
B3 is integrated over A3's persisted plans and cursors and owns the live Paper observation/mutation boundary. C1 and C2 are the remaining independent operations items; D1 is the later command-to-inventory repair UX follow-up.
