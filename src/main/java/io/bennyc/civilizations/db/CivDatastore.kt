        ...
        try {
            ...
            if (results != null) {
                if (results.next()) {
                    ...
                    val citizens: MutableSet<io.bennyc.civilizations.model.CivPlayer> = deserializedCiv.citizens
                    val relationships = deserializedCiv.relationships
                    val bank: io.bennyc.civilizations.model.Bank = deserializedCiv.bank
                ...
                } else io.bennyc.civilizations.manager.CivManager.removeCiv(civ)
            }
