...
- [x] **S4: finite diamond preparation and reconstruction boundary.** New unopened-world preparation/audit tool, resource exclusions across battle/exposure journals and saved repairs, explicit SQL-backed diamond loot/trade/equipment-spawn restrictions (schema 17). Isolated 2048 preparation and Paper verification; [contract and limitations](docs/diamond-scarcity.md). Integrated all-dimension release audit remains S5.
