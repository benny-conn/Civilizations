...
| Battles | Durable war relationship plus timed hostile-entry battle, roster snapshot, terminal result, and expiry recovery | Core is restart-safe and simple battle block mutation is live; Paper hostile-entry, PVP, elimination, and player-facing operations remain |
